...
int doDump(Bundle* bundle)
{
    ...
    if (strcmp("resources", option) == 0) {
        ...
        if (strcmp("permissions", option) == 0) {
            ...
            Vector<const char*>* tmpUsesPermission = new Vector<const char*>();
            Vector<const char*>* tmpUsesFeature = new Vector<const char*>();
            ...
            while ((code=tree.next()) != ResXMLTree::END_DOCUMENT && code != ResXMLTree::BAD_DOCUMENT) {
                ...
                if (depth == 1) {
                    ...
                    if (versionCode > 0) {
                    	...
                    	sprintf(buf, "%d", versionCode);
                    	bundle->setVersionCode(buf);
                    ...
                    char* vn = new char[64];
                    strcpy(vn, versionName.string());
                    bundle->setVersionName(vn);
                    ...
                    if (tag == "application") {
                        ...
                        Vector<String8>* labels = new Vector<String8>();
                        for (size_t i=0; i<NL; i++) {
                            ...
                            if (llabel != "") {
                                ...
                                if (localeStr == NULL || strlen(localeStr) == 0) {
                                    ...
                                    sprintf(l, "application-label:'%s'", llabel.string());
                                    String8* tmpL = new String8(l);
                                    labels->add(*tmpL);
                                } else {
                                    if (label == "") {
                                        label = llabel;
                                    ...
                                    printf("application-label-%s:'%s'\n", localeStr,
                                            llabel.string());
                                    sprintf(l, "application-label-%s:'%s'", localeStr, llabel.string());
                                    String8* tmpL = new String8(l);
                                    labels->add(*tmpL);
                                }
                            }
                        }
                        bundle->setApplicationLabels(*labels);

                        Vector<const char*>* icons = new Vector<const char*>();
                        ...
                        for (size_t i=0; i<ND; i++) {
                            ...
                            if (icon != "") {
                                ...
                                char* tmpIcon = new char[128];
                                sprintf(tmpIcon, "application-icon-%d:'%s'", densities[i], icon.string());
                                icons->add(tmpIcon);
                            }
                        }
                        assets.setConfiguration(config);

                        bundle->setApplicationIcons(*icons);
                        ...
                        if (error != "") {
                            ...
                            char* minSdk = new char[128];
                            sprintf(minSdk, "%d", code);
                            bundle->setMinSdkVersion(minSdk);
                        }
                        code = getIntegerAttribute(tree, MAX_SDK_VERSION_ATTR, NULL, -1);
                        if (code != -1) {
                            printf("maxSdkVersion:'%d'\n", code);

                            char* maxSdk = new char[128];
                            sprintf(maxSdk, "%d", code);
                            bundle->setMaxSdkVersion(maxSdk);
                        }
                        ...
                        if (error != "") {
                            ...
                            char* targetSdk = new char[128];
                            sprintf(targetSdk, "%d", code);
                            bundle->setTargetSdkVersion(targetSdk);
                        }
                        ...
                        if (name != "" && error == "") {
                            ...
                            char* f = new char[512];
                            sprintf(f, "uses-feature%s:'%s'\n",
                                    req ? "" : "-not-required", name.string());
                            tmpUsesFeature->add(f);
            ...
            if (!specCameraFeature) {
                if (reqCameraFlashFeature) {
                    ...
                    tmpUsesFeature->add("uses-feature:'android.hardware.camera'");
                    ...
                    if (!specCameraAutofocusFeature) {
                        ...
                        tmpUsesFeature->add("uses-feature:'android.hardware.camera.autofocus'");
                    }
                }
            }
            ...
            if (!specLocationFeature &&
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.location'");
            }
            if (!specGpsFeature && hasGpsPermission) {
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.location.gps'");
            }
            if (!specNetworkLocFeature && hasCoarseLocPermission) {
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.location.network'");
            }
            ...
            if (!specBluetoothFeature && hasBluetoothPermission && (targetSdk > 4)) {
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.bluetooth'");
            }
            ...
            if (!specMicrophoneFeature && hasRecordAudioPermission) {
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.microphone'");
            }
            ...
            if (!specWiFiFeature && hasWiFiPermission) {
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.wifi'");
            }
            ...
            if (!specTelephonyFeature && (hasTelephonyPermission || reqTelephonySubFeature)) {
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.telephony'");
            }
            ...
            if (!specTouchscreenFeature) { // not a typo!
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.touchscreen'");
            }
            if (!specMultitouchFeature && reqDistinctMultitouchFeature) {
                ...
                tmpUsesFeature->add("uses-feature:'android.hardware.touchscreen.multitouch'");
            }
            ...
            if (!specScreenLandscapeFeature && !specScreenPortraitFeature) {
                ...
                if (reqScreenLandscapeFeature) {
                    ...
                    tmpUsesFeature->add("uses-feature:'android.hardware.screen.landscape'");
                }
                if (reqScreenPortraitFeature) {
                    ...
                    tmpUsesFeature->add("uses-feature:'android.hardware.screen.portrait'");
                }
            }
            ...
            Vector<const char*>* tmpSupportScreen = new Vector<const char*>();
            if (smallScreen != 0) {
            	tmpSupportScreen->add("small");
            	printf(" 'small'");
            }
            if (normalScreen != 0) {
            	tmpSupportScreen->add("normal");
            	printf(" 'normal'");
            }
            if (largeScreen != 0) {
            	tmpSupportScreen->add("large");
            	printf(" 'large'");
            }
            if (xlargeScreen != 0) {
            	tmpSupportScreen->add("xlarge");
            	printf(" 'xlarge'");
            }
            bundle->setSupportScreens(*tmpSupportScreen);
            printf("\n");
            printf("supports-any-density: '%s'\n", anyDensity ? "true" : "false");
            if (anyDensity) {
            	bundle->setSupportAnyDensity(true);
            } else {
            	bundle->setSupportAnyDensity(false);
            }
            ...
            printf("locales:");
            Vector<const char*>* tmpLocales = new Vector<const char*>();
            const size_t NL = locales.size();
            for (size_t i=0; i<NL; i++) {
                const char* localeStr =  locales[i].string();
                if (localeStr == NULL || strlen(localeStr) == 0) {
            ...
            bundle->setLocales(*tmpLocales);
            printf("\n");

            Vector<int>* tmpDensities = new Vector<int>();
            printf("densities:");
            const size_t ND = densities.size();
            for (size_t i=0; i<ND; i++) {
                printf(" '%d'", densities[i]);
                tmpDensities->add(densities[i]);
            }
            printf("\n");

            bundle->setDensities(*tmpDensities);

            Vector<const char*>* tmpNativeCodes = new Vector<const char*>();
            ...
            if (dir != NULL) {
                if (dir->getFileCount() > 0) {
                    ...
                    for (size_t i=0; i<dir->getFileCount(); i++) {
                        ...
                        strcpy(buf, dir->getFileName(i).string());
                        tmpNativeCodes->add(buf);
                    }
                    printf("\n");
                }
                delete dir;
            ...
            bundle->setNativeCodes(*tmpNativeCodes);

            bundle->setUsesFeatures(*tmpUsesFeature);
            bundle->setUsesPermissions(*tmpUsesPermission);
